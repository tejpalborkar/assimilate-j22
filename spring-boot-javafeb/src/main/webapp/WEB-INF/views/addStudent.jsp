...
<body>
	...
	<form:form action="/students/addStudent" method="post" modelAttribute="student">
		...
		<form:input type="hidden" path="id" class="form-control" placeholder="firstName" autofocus="true"></form:input> <br>
