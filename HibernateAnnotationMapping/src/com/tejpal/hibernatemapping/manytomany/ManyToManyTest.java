...
public class ManyToManyTest {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("Tejpal");
...
//		Student studentFetched = (Student) session.get(Student.class, 5L);
//		System.out.println(studentFetched + " Courses : " + studentFetched.getCourses().size());
//
...
//		Course course = (Course) session.get(Course.class, 11L);
...
//
		...
		Student stu = (Student) session.get(Student.class, 10L);
