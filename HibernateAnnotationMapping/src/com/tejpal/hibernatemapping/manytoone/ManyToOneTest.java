...
public class ManyToOneTest {
	public static void main(String[] args) {
		...
		try {
			...
			Address address = new Address("Kumthekar chawk", "Pune", "MH", "411001");
...
////			  
//			  address.setStudents(students); //If we save address object first then it will
//////			  be one to many session.save(address);
////			  
...
//			  
			  ...
			  Address addressFetched = (Address) session.get(Address.class,  3L); 
